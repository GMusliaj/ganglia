---
name: remember
description: Distill durable knowledge or save a resumable checkpoint into the cross-repository Brain, with privacy routing and security-gated auto-commit. Use when the user asks to remember, retain, record, or checkpoint something for later.
---
...
routing, OKF-lite format, indexing, Security Baseline, and reporting contract.
