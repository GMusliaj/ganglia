---
name: remember
description: Distill durable knowledge, materialize a reusable safe operation, or save a resumable checkpoint into the cross-repository Ganglia, with privacy routing and security-gated auto-commit. Use when the user asks to remember, retain, record, or checkpoint something for later.
---

# Remember

Capture knowledge in the Ganglia checkout containing this skill. Resolve the real
...
[references/workflow.md](references/workflow.md) and the Ganglia `README.md`.
