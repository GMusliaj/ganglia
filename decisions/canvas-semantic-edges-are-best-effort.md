...
- `bin/canvas.py` renders a disposable, offline HTML view of Ganglia knowledge.
...
- Markdown remains canonical and the generated `.tmp/ganglia-canvas.html` is
  ignored. This follows [QMD's ceiling-not-floor decision](retrieval-tiering-qmd-is-ceiling-not-floor.md).

## Source

The Ganglia canvas reference implementation and local QMD 2.8.3 schema inspection.
